...
class SimpleStrategy(bt.Strategy):
    params = (('fast', 12), ('slow', 26),
              ('order_percentage', 0.95), ('ticker', 'DOT'))
    # fast-12, slow-26
    ...
    def __init__(self):
        ...
        self.stoc = bt.talib.STOCH(
            self.data.high, self.data.low, self.data.close, fastk_period=14, slowk_period=3)
    ...
    def next(self):
        ...
        if self.position.size == 0:
            ...
            if (self.crossover > 0) and (90 > self.stoc > 40):
                ...
                print(
                    f"Buying {self.size} shares of {self.params.ticker} at {self.data.close[0]}")
        ...
        if (self.position.size > 0) and (10 < self.stoc < 60):
            ...
            if self.crossover < 0:
                print(
                    f"Selling {self.size} shares of {self.params.ticker} at {self.data.close[0]}")
